...
import { selectBalance, selectCustomer, selectUsername, logout, type Customer } from "../../reducers/customerSlice";
...
export default function CustomerMenu() {
  ...
  const balance: number | undefined = useAppSelector(selectBalance);
        ...
        <Toolbar disableGutters >
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
            ...
            <Box sx={{display: { xs: 'none', md: 'flex' }, alignItems: 'center', ml: 'auto', cursor: 'pointer'}} onClick={navigateToHome}>
              ...
              <Badge badgeContent={balance} max={1000000000000} color='secondary' showZero sx={{mr:3,}}>
          ...
          <Box sx={{display: { xs: 'flex', md: 'none' }, alignItems: 'center', cursor: 'pointer'}} onClick={navigateToHome}>
            <Typography
              ...
              <Badge badgeContent={balance} max={1000000000000} color='secondary' showZero>
                  <WalletIcon fontSize="large" />
              </Badge>
          </Box>
